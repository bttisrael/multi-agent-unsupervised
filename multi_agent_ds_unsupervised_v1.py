"""
Auto Segmenter AI v1 — Multi-Agent Unsupervised Learning Pipeline
=================================================================
...
def generate_readme() -> None:
    ...
    cfg = load_json(out_path("entity_config")) if out_path("entity_config").exists() else {}
    readme = f"""# Auto Segmenter AI — Multi-Agent Unsupervised Learning
...
```json
{json.dumps(best, indent=2, ensure_ascii=False, default=json_safe)}
```
...
"""
    out_path("readme").write_text(readme, encoding="utf-8")
...
def run_pipeline() -> None:
    ensure_output_dir()
    logger.info("Starting Auto Segmenter AI v1")
